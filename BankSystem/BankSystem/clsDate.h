...
public:
	...
	clsDate(string sDate)
	{
		...
		vector <string> vDate;
		vDate = clsString::Spilt_String(sDate, "/");
   ...
   void Print()
	...
	static string DateToString(clsDate Date)
	{
		...
		Datee += to_string(Date.Day) + "/";
		if (Date.Month < 10)
		{
			Datee += "0";
		}

		Datee += (to_string(Date.Month) + "/");

		Datee += to_string(Date.Year);
		return  Datee;
	}
